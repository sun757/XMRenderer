...
int main()
{
    ...
    //  shader
    Shader ourShader(".\\shader\\flash_lighting.vs", ".\\shader\\flash_lighting.fs"); // you can name your shader files however you like
...
// -----------------------------------------------------------------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos = glm::vec3(0.6f, 0.0f, 2.0f);
        glm::mat4 trans = glm::mat4(1.0f);
        trans = glm::rotate(trans, (float)glfwGetTime(), glm::vec3(0.0f, 1.0f, 0.0f));
        lightPos = glm::vec3(trans * glm::vec4(lightPos, 1.0));
        ...
        ourShader.setVec3("light.direction", glm::normalize(glm::vec3(0,0,0)- lightPos));
        ourShader.setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));
        // material properties
